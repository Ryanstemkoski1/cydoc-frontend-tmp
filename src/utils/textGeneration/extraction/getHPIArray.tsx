...
import { extractHpiArray } from './extractHpi';
import { splitByPeriod } from '../common/textUtils';
import { fillAnswers } from '../processing/fillHPIAnswers';
import { doAllHPIWordReplacements } from '../processing/handleHPIWordReplacements';
/**
