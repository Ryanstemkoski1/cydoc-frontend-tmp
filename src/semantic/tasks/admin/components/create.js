    ...
    for (index in release.components) {
        ...
        (function (component) {
            var outputDirectory = path.join(release.outputRoot, component),
                isJavascript = fs.existsSync(
                    output.compressed + component + '.js'
                ),
                ...
                gitURL =
                    ...
                    '.git',
                repoURL =
                    'https://github.com/' + release.org + '/' + repoName + '/',
                concatSettings = {
                    newline: '',
                ...
                manifest = {
                    assets:
                        outputDirectory + '/assets/**/' + component + '?(s).*',
                    component:
                        outputDirectory + '/' + component + '+(.js|.css)',
                };
            ...
            gulp.task(task.npm, false, function () {
                return gulp
                    ...
                    .pipe(
                        replace(
                            regExp.match.settingsExport,
                            regExp.replace.settingsExport
                        )
                    )
                    .pipe(
                        replace(
            ...
            gulp.task(task.readme, false, function () {
                return gulp
                    ...
                    .pipe(
                        replace(
                            regExp.match.titleName,
                            regExp.replace.titleName
                        )
                    )
                    .pipe(gulp.dest(outputDirectory));
            });
                ...
                return gulp
                    ...
                    .pipe(
                        jsonEditor(function (bower) {
                            ...
                            bower.description =
                                capitalizedComponent + ' - Semantic UI';
                            if (isJavascript) {
                                if (isCSS) {
                                    bower.main = [
                                        component + '.js',
                ...
                return gulp
                    ...
                    .pipe(
                        jsonEditor(function (npm) {
                            ...
                            npm.description =
                                'Single component release of ' + component;
                            npm.repository = {
                                type: 'git',
                                url: gitURL,
                            };
            ...
            gulp.task(task.notes, false, function () {
                return (
                    gulp
                        ...
                        .pipe(
                            replace(
                                regExp.match.spacedLists,
                                regExp.replace.spacedLists
                            )
                        )
                        ...
                        gulp.src(manifest.assets)
                            ...
                            .on('end', function () {
                                ...
                                gulp.src(release.templates.meteor.component)
                                    ...
                                    .pipe(
                                        replace(regExp.match.version, version)
                                    )
                                    .pipe(
                                        replace(regExp.match.files, filenames)
                                    )
