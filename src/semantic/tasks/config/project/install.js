...
var when = {
    ...
    changePermissions: function (questions) {
        return (
            questions.changePermissions && questions.changePermissions === true
        );
    },
...
module.exports = {
    ...
    createJSON: function (answers) {
        ...
        if (answers.compressed) {
            json.paths.output.compressed = path.normalize(
                answers.compressed + '/'
            );
        }
    ...
    questions: {
        ...
        setup: [
            ...
            },
            {
                ...
                name: 'permission',
                message:
                    'What octal file permission should outputted files receive?',
        ...
        site: [
            ...
            },
            {
                ...
                name: 'secondaryColor',
                message:
                    'Select the closest name for your secondary brand color',
                default: '14px',
                choices: [
                    {
                        name: 'Blue',
