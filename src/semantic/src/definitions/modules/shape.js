        ...
        $allModules.each(function () {
            ...
            module = {
                ...
                is: {
                    complete: function () {
                        return (
                            $side.filter('.' + className.active)[0] ==
                            $nextSide[0]
                        );
                    },
                    animating: function () {
                ...
                set: {
                    ...
                    stageSize: function () {
                        ...
                        if (settings.width != 'auto') {
                            ...
                            module.verbose(
                                'Specifying width during animation',
                                newWidth
                            );
                        }
                        if (settings.height != 'auto') {
                            ...
                            module.verbose(
                                'Specifying height during animation',
                                newHeight
                            );
                        }
                    },
                ...
                stage: {
                    above: function () {
                        ...
                        $sides.css({
                            transform:
                                'translateZ(-' + box.depth.active + 'px)',
                        });
                        $activeSide.css({
                            transform:
