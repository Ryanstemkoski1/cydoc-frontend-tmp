        ...
        $allModules.each(function () {
            ...
            module = {
                ...
                event: {
                    ...
                    history: {
                        change: function (event) {
                            var tabPath =
                                    event.pathNames.join('/') ||
                                    module.get.initialPath(),
                                pageTitle =
                                    settings.templates.determineTitle(
                                        tabPath
                                    ) || false;
                ...
                changeTab: function (tabPath) {
                    var pushStateAvailable =
                            window.history && window.history.pushState,
                        shouldIgnoreLoad =
                            pushStateAvailable &&
                            settings.ignoreFirstLoad &&
                            firstLoad,
                        remoteContent =
                            settings.auto ||
                            $.isPlainObject(settings.apiSettings),
                    ...
                    $.each(pathArray, function (index, tab) {
                        var currentPathArray = pathArray.slice(0, index + 1),
                            currentPath =
                                module.utilities.arrayToPath(currentPathArray),
                        ...
                        if (isTab) {
                            ...
                            if (isLastIndex) {
                                ...
                                nextPath =
                                    module.utilities.arrayToPath(nextPathArray);
                            ...
                            apiSettings = {
                                ...
                                onSuccess: function (response) {
                                    ...
                                    if (settings.loadOnce) {
                                        ...
                                        typeof settings.cacheType == 'string' &&
                                        settings.cacheType.toLowerCase() ==
                                            'dom' &&
                ...
                get: {
                    ...
                    defaultPath: function (tabPath) {
                        var $defaultNav = $allModules
                                ...
                                .eq(0),
                            defaultTab =
                                $defaultNav.data(metadata.tab) || false;
                        if (defaultTab) {
