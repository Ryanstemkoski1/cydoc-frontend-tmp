            ...
            module = {
                ...
                determine: {
                    searchFields: function () {
                        ...
                        if (
                            parameters &&
                            parameters.searchFields !== undefined
                        ) {
                ...
                event: {
                    ...
                    focus: function () {
                        module.set.focus();
                        if (
                            settings.searchOnFocus &&
                            module.has.minimumCharacters()
                        ) {
                    ...
                    result: {
                        ...
                        click: function (event) {
                            ...
                            var $result = $(this),
                                ...
                                value =
                                    $title.length > 0 ? $title.text() : false,
                ...
                handleKeyboard: function (event) {
                    ...
                    if (module.is.visible()) {
                        if (keyCode == keys.enter) {
                            ...
                            if (
                                $result.filter('.' + className.active).length >
                                0
                            ) {
                ...
                is: {
                    ...
                    inMessage: function (event) {
                        ...
                        return (
                            isInDOM &&
                            $target.closest(selector.message).length > 0
                        );
                    },
                    empty: function () {
                        return $results.html() === '';
                ...
                get: {
                    settings: function () {
                        if (
                            ...
                            module.error(
                                settings.error.oldSearchSyntax,
                                element
                            );
                        }
                    },
                    ...
                    result: function (value, results) {
                        var lookupFields = ['title', 'id'],
                            result = false;
                        value =
                            value !== undefined ? value : module.get.value();
                        results =
                            results !== undefined
                                ? results
                                : module.get.results();
                ...
                search: {
                    local: function (searchTerm) {
                        var results = module.search.object(
                                searchTerm,
                                settings.content
                            ),
                            searchHTML;
                        ...
                        module.debug(
                            'Returned full local search results',
                            results
                        );
                        if (settings.maxResults > 0) {
                            module.debug(
                                'Using specified max results',
                                results
                            );
                    ...
                    object: function (searchTerm, source, searchFields) {
                        var results = [],
                            ...
                            searchExp = searchTerm
                                .toString()
                                .replace(regExp.escape, '\\$&'),
                            matchRegExp = new RegExp(
                                regExp.beginsWith + searchExp,
                                'i'
                            ),
                            // avoid duplicates when pushing results
                            addResult = function (array, result) {
                                var notResult =
                                        $.inArray(result, results) == -1,
                                    notFuzzyResult =
                                        $.inArray(result, fuzzyResults) == -1,
                                    notExactResults =
                                        $.inArray(result, exactResults) == -1;
                                if (
                                    notResult &&
                                    notFuzzyResult &&
                                    notExactResults
                        ...
                        $.each(searchFields, function (index, field) {
                            $.each(source, function (label, content) {
                                ...
                                if (fieldExists) {
                                    if (
                                        content[field].search(matchRegExp) !==
                                        -1
                                    ) {
                ...
                create: {
                    categoryResults: function (results) {
                        ...
                        $.each(results, function (index, result) {
                            ...
                            if (
                                categoryResults[result.category] === undefined
                            ) {
                                module.verbose(
                                ...
                                categoryResults[result.category].results.push(
                                    result
                                );
                            }
                        });
                                ...
                                $.each(
                                    ...
                                    function (index, value) {
                                        ...
                                        if (result.id === undefined) {
                                            result.id = module.create.id(
                                                resultIndex,
                                                categoryIndex
                                            );
                                        }
                                        module.inject.result(
                                            result,
                                            resultIndex,
                                            categoryIndex
                                        );
                ...
                addResults: function (html) {
                    if ($.isFunction(settings.onResultsAdd)) {
                        if (
                            settings.onResultsAdd.call($results, html) === false
                        ) {
                            module.debug(
                    ...
                    if (isProperObject || isProperArray) {
                        if (settings.maxResults > 0) {
                            if (isProperObject) {
                                ...
                                response[fields.results] = response[
                                    fields.results
        ...
        templates: {
            ...
            category: function (response, fields) {
                ...
                if (response[fields.categoryResults] !== undefined) {
                    // each category
                    $.each(
                        response[fields.categoryResults],
                        function (index, category) {
                            if (
                                ...
                                if (
                                    category[fields.categoryName] !== undefined
                                ) {
                                    html +=
                                        '<div class="name">' +
