        ...
        $allModules.each(function () {
            ...
            module = {
                ...
                showModal: function (callback) {
                    ...
                    if (module.is.animating() || !module.is.active()) {
                        ...
                        if (module.can.useFlex()) {
                            ...
                            module.set.modalOffset();
                            module.debug(
                                'Using non-flex legacy modal positioning.'
                            );
                        }
                        module.set.screenHeight();
                        module.set.type();
                ...
                others: {
                    active: function () {
                        return (
                            $otherModals.filter('.' + className.active).length >
                            0
                        );
                    },
                    animating: function () {
                        return (
                            $otherModals.filter('.' + className.animating)
                                .length > 0
                        );
                    },
                },
                ...
                save: {
                    focus: function () {
                        var $activeElement = $(document.activeElement),
                            inCurrentModal =
                                $activeElement.closest($module).length > 0;
                        if (!inCurrentModal) {
                ...
                can: {
                    ...
                    fit: function () {
                        ...
                        return scrollHeight > height
                            ? startPosition + scrollHeight + paddingHeight <
                                  contextHeight
                ...
                set: {
                    ...
                    modalOffset: function () {
                        ...
                        $module.css({
                            marginTop:
                                settings.centered && module.can.fit()
                                    ? -(height / 2)
                                    : 0,
                            marginLeft: -(width / 2),
                        });
