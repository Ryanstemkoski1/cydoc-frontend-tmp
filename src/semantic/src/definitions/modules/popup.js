            ...
            module = {
                ...
                refresh: function () {
                    ...
                    if (settings.popup) {
                        ...
                        if (
                            settings.movePopup &&
                            module.has.popup() &&
                            module.get.offsetParent($popup)[0] !==
                                $offsetParent[0]
                        ) {
                            module.debug(
                    ...
                    if (
                        $offsetParent.is('html') &&
                        $offsetParent[0] !== $body[0]
                    ) {
                ...
                event: {
                    ...
                    hideGracefully: function (event) {
                        var $target = $(event.target),
                            ...
                            inPopup =
                                $target.closest(selector.popup).length > 0;
                ...
                get: {
                    ...
                    variation: function () {
                        ...
                        return (
                            $module.data(metadata.variation) ||
                            settings.variation
                        );
                    },
                    popup: function () {
                    ...
                    calculations: function () {
                        var $popupOffsetParent =
                                module.get.offsetParent($popup),
                            targetElement = $target[0],
                            isWindow = $boundary[0] == window,
                            targetPosition =
                                settings.inline ||
                                (settings.popup && settings.movePopup)
                                    ? $target.position()
                                    : $target.offset(),
                        ...
                        if (
                            $popupOffsetParent.get(0) !== $offsetParent.get(0)
                        ) {
                            var popupOffset = $popupOffsetParent.offset();
                            calculations.target.top -= popupOffset.top;
                            calculations.target.left -= popupOffset.left;
                            calculations.parent.width =
                                $popupOffsetParent.outerWidth();
                            calculations.parent.height =
                                $popupOffsetParent.outerHeight();
                        }
                        ...
                        if (settings.setFluidWidth && module.is.fluid()) {
                            ...
                            calculations.popup.width =
                                calculations.container.width;
                        }
                        ...
                        calculations.boundary = {
                            ...
                            bottom:
                                screen.top + screen.scroll.top + screen.height,
                            left: screen.left + screen.scroll.left,
                            right:
                                screen.left + screen.scroll.left + screen.width,
                        };
                        return calculations;
                    },
                    id: function () {
                    ...
                    distanceFromBoundary: function (offset, calculations) {
                        var distanceFromBoundary = {},
                            ...
                            boundary;
                        calculations =
                            calculations || module.get.calculations();
                    ...
                    nextPosition: function (position) {
                        ...
                        if (settings.prefer === 'opposite') {
                            nextPosition = [
                                opposite[verticalPosition],
                                horizontalPosition,
                            ];
                            nextPosition = nextPosition.join(' ');
                            oppositeTried =
                                triedPositions[nextPosition] === true;
                            module.debug(
                                'Trying opposite strategy',
                                nextPosition
                            );
                        }
                        if (
                            settings.prefer === 'adjacent' &&
                            adjacentsAvailable
                        ) {
                            nextPosition = [
                                verticalPosition,
                                adjacent[horizontalPosition],
                            ];
                            nextPosition = nextPosition.join(' ');
                            adjacentTried =
                                triedPositions[nextPosition] === true;
                            module.debug(
                                'Trying adjacent strategy',
                                nextPosition
                            );
                        }
                ...
                set: {
                    position: function (position, calculations) {
                        ...
                        position =
                            position ||
                            $module.data(metadata.position) ||
                            settings.position;

                        offset =
                            $module.data(metadata.offset) || settings.offset;
                ...
                bind: {
                    events: function () {
                        ...
                        if (module.get.startEvent()) {
                            $module
                                ...
                                .on(
                                    module.get.endEvent() + eventNamespace,
                                    module.event.end
                                );
                        }
                        if (settings.target) {
                    ...
                    closeOnScroll: function () {
                        module.verbose(
                            'Binding scroll close event to document'
                        );
                        $scrollContext.one(
                    ...
                    touchClose: function () {
                        module.verbose(
                            'Binding popup touchclose event to document'
                        );
                        $document.on(
                            'touchstart' + elementNamespace,
                            function (event) {
                                module.verbose('Touched away from popup');
                                module.event.hideGracefully.call(
                                    element,
                                    event
                                );
                            }
                ...
                should: {
                    centerArrow: function (calculations) {
                        return (
                            !module.is.basic() &&
                            calculations.target.width <=
                                settings.arrowPixelsFromEdge * 2
                        );
                    },
                },
                ...
                is: {
                    ...
                    fluid: function () {
                        return (
                            $popup !== undefined &&
                            $popup.hasClass(className.fluid)
                        );
                    },
                    visible: function () {
                        return (
                            $popup !== undefined &&
                            $popup.hasClass(className.popupVisible)
                        );
                    },
                    dropdown: function () {
