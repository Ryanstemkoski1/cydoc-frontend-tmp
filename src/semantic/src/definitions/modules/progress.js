            ...
            module = {
                ...
                increment: function (incrementValue) {
                    ...
                    if (module.has.total()) {
                        ...
                        incrementValue =
                            incrementValue || module.get.randomValue();
                ...
                decrement: function (decrementValue) {
                    ...
                    if (total) {
                        ...
                        startValue = module.get.percent();
                        decrementValue =
                            decrementValue || module.get.randomValue();
                        newValue = startValue - decrementValue;
                        module.debug(
                ...
                get: {
                    ...
                    randomValue: function () {
                        ...
                        return Math.floor(
                            Math.random() * settings.random.max +
                                settings.random.min
                        );
                    },
                    ...
                    displayPercent: function () {
                        ...
                        return settings.precision > 0
                            ? Math.round(
                                  displayPercent * (10 * settings.precision)
                              ) /
                ...
                set: {
                    ...
                    state: function (percent) {
                        percent =
                            percent !== undefined ? percent : module.percent;
                        if (percent === 100) {
                            if (
                    ...
                    barLabel: function (text) {
                        if (text !== undefined) {
                            ...
                            $progress.text(
                                module.get.text(settings.text.ratio)
                            );
                        } else if (settings.label == 'percent') {
                            module.verbose('Adding percentage to bar label');
                            $progress.text(
                                module.get.text(settings.text.percent)
                            );
                        }
                    },
                    ...
                    success: function (text) {
                        text =
                            text ||
                            settings.text.success ||
                            settings.text.active;
