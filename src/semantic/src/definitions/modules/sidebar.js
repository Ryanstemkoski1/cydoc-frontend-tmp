            ...
            module = {
                ...
                event: {
                    ...
                    scroll: function (event) {
                        if (
                            $(event.target).closest(selector.sidebar).length ===
                            0
                        ) {
                        ...
                        if (settings.closable) {
                            $context
                                .on(
                                    ...
                                    module.event.clickaway
                                )
                                .on(
                                    'touchend' + elementNamespace,
                                    module.event.clickaway
                                );
                        }
                    },
                ...
                add: {
                    inlineCSS: function () {
                        var width = module.cache.width || $module.outerWidth(),
                            height =
                                module.cache.height || $module.outerHeight(),
                            isRTL = module.is.rtl(),
                ...
                othersAnimating: function () {
                    return (
                        $sidebars.not($module).filter('.' + className.animating)
                            .length > 0
                    );
                },
                othersVisible: function () {
                    return (
                        $sidebars.not($module).filter('.' + className.visible)
                            .length > 0
                    );
                },
                ...
                is: {
                    ...
                    ios: function () {
                        var userAgent = navigator.userAgent,
                            ...
                            isMobileChrome = userAgent.match(
                                regExp.mobileChrome
                            );
