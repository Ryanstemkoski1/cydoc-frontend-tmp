    ...
    $.fn.transition = function () {
        ...
        $allModules.each(function (index) {
            ...
            module = {
                initialize: function () {
                    // get full settings
                    settings = module.get.settings.apply(
                        element,
                        moduleArguments
                    );
                ...
                queue: function (animation) {
                    ...
                    module.queuing = true;
                    $module.one(
                        animationEnd + '.queue' + eventNamespace,
                        function () {
                    ...
                    direction: function (animation) {
                        ...
                        if (typeof animation === 'string') {
                            ...
                            $.each(animation, function (index, word) {
                                if (
                                    word === className.inward ||
                                    word === className.outward
                                ) {
                                    hasDirection = true;
                                }
                            });
                ...
                start: {
                    animation: function (animationClass) {
                        animationClass =
                            animationClass || module.get.animationClass();
                ...
                get: {
                    ...
                    currentAnimation: function () {
                        return module.cache &&
                            module.cache.animation !== undefined
                ...
                can: {
                    transition: function (forced) {
                        var animation = settings.animation,
                            transitionExists =
                                module.get.transitionExists(animation),
                        ...
                        if (transitionExists === undefined || forced) {
                            ...
                            if (currentAnimation != inAnimation) {
                                ...
                                module.debug(
                                    'Static animation found',
                                    animation,
                                    displayType
                                );
                                directionExists = false;
                            }
                            module.save.transitionExists(
                                animation,
                                directionExists
                            );
                        }
