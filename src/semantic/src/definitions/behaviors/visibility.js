        ...
        $allModules.each(function () {
            ...
            module = {
                    ...
                    if (!disabled && module.is.visible()) {
                        ...
                        if (settings.onUpdate) {
                            settings.onUpdate.call(
                                element,
                                module.get.elementCalculations()
                            );
                        }
                    }
                },
                ...
                bottomVisibleReverse: function (newCallback) {
                    var calculations = module.get.elementCalculations(),
                        callback =
                            newCallback || settings.onBottomVisibleReverse,
                ...
                bottomPassedReverse: function (newCallback) {
                    var calculations = module.get.elementCalculations(),
                        callback =
                            newCallback || settings.onBottomPassedReverse,
                ...
                save: {
                    ...
                    elementCalculations: function () {
                        ...
                        if (settings.includeMargin) {
                            ...
                            element.top =
                                element.offset.top - element.margin.top;
                            element.bottom =
                                element.offset.top +
                                element.height +
                        ...
                        // meta calculations
                        element.onScreen =
                            (element.topVisible || element.passing) &&
                            !element.bottomPassed;
                        element.passing =
                            element.topPassed && !element.bottomPassed;
                    ...
                    screenCalculations: function () {
                        ...
                        module.cache.screen.bottom =
                            scroll + module.cache.screen.height;
                ...
                get: {
                    pixelsPassed: function (amount) {
                        ...
                        if (amount.search('%') > -1) {
                            return (
                                element.height * (parseInt(amount, 10) / 100)
                            );
                        }
