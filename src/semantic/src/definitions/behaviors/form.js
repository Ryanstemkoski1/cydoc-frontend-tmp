            ...
            module = {
                ...
                clear: function () {
                    $field.each(function () {
                        var $field = $(this),
                            ...
                            defaultValue =
                                $field.data(metadata.defaultValue) || '',
                ...
                determine: {
                    isValid: function () {
                        ...
                        $.each(validation, function (fieldName, field) {
                            if (
                                !module.validate.field(field, fieldName, true)
                            ) {
                                allValid = false;
                            }
                        });
                ...
                is: {
                    bracketedRule: function (rule) {
                        return (
                            rule.type &&
                            rule.type.match(settings.regExp.bracket)
                        );
                    },
                    ...
                    field: {
                        keydown: function (event) {
                            var $field = $(this),
                                ...
                                isInDropdown =
                                    $field.closest(selector.uiDropdown).length >
                                    0,
                                keyCode = {
                                    enter: 13,
                                    escape: 27,
                ...
                get: {
                    ancillaryValue: function (rule) {
                        if (
                            !rule.type ||
                            (!rule.value && !module.is.bracketedRule(rule))
                        ) {
                            return false;
                        }
                    ...
                    inputEvent: function () {
                        return document.createElement('input').oninput !==
                            undefined
                            ? 'input'
                    ...
                    settings: function () {
                        if ($.isPlainObject(parameters)) {
                            var keys = Object.keys(parameters),
                                isLegacySettings =
                                    keys.length > 0
                                        ? parameters[keys[0]].identifier !==
                                              undefined &&
                                          parameters[keys[0]].rules !==
                                              undefined
                                        : false,
                                ruleKeys;
                            if (isLegacySettings) {
                                ...
                                if (
                                    ...
                                    parameters.fields =
                                        module.get.fieldsFromShorthand(
                                            parameters.fields
                                        );
                                }
                                settings = $.extend(
                ...
                set: {
                    ...
                    defaults: function () {
                        $field.each(function () {
                            var $field = $(this),
                                isCheckbox =
                                    $field.filter(selector.checkbox).length > 0,
                                value = isCheckbox
                                    ? $field.is(':checked')
                                    : $field.val();
                    ...
                    values: function (fields) {
                        ...
                        $.each(fields, function (key, value) {
                            var $field = module.get.field(key),
                                ...
                                isDropdown = $element.is(selector.uiDropdown),
                                isRadio =
                                    $field.is(selector.radio) && isCheckbox,
                ...
                validate: {
                    form: function (event, ignoreCallbacks) {
                        ...
                        if (module.determine.isValid()) {
                            ...
                            if (ignoreCallbacks !== true) {
                                return settings.onSuccess.call(
                                    element,
                                    event,
                                    values
                                );
                            ...
                            if (ignoreCallbacks !== true) {
                                return settings.onFailure.call(
                                    element,
                                    formErrors,
                                    values
                                );
                    ...
                    field: function (field, fieldName, showErrors) {
                        showErrors =
                            showErrors !== undefined ? showErrors : true;
    ...
    $.fn.form.settings = {
        ...
        rules: {
            ...
            creditCard: function (cardNumber, cardTypes) {
                    ...
                    $.each(requiredTypes, function (index, type) {
                        ...
                        if (validation) {
                            valid = {
                                ...
                                pattern:
                                    cardNumber.search(validation.pattern) !==
                                    -1,
                            };
                ...
                unionPay = {
                    number:
                        $.inArray(cardNumber.length, cards.unionPay.length) !==
                        -1,
                ...
                while (length--) {
                    sum +=
                        producedValue[multiple][
                            parseInt(cardNumber.charAt(length), 10)
                        ];
                    multiple ^= 1;
                }
