...
export const HOME_MED_BP = 820;
export const HOME_SMALL_BP = 625;
export const HOME_XS_BP = 425;
...
export const FAMILY_HISTORY_MOBILE_BP = 768;

export const PATIENT_HISTORY_MOBILE_BP = 750;
export const PATIENT_HISTORY_ALLERGIES_MOBILE_BP = 800;
