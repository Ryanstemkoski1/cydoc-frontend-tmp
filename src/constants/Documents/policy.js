        ...
        <div className='scroll'>
            ...
            <div style={stylingObject.body}>
                ...
                <div>
                    <div>
                        <p>
                            This privacy notice for Cydoc Corporation
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    (Cydoc), or any other application of ours
                    ...
                    <p>
                        <strong>
                            <i>
                                ...
                                details by using our table of contents to find
                ...
                <div>
                    <p>
                        ...
                        interact with Cydoc Corporation and the Services, the
                ...
                <div>
                    <p>
                        ...
                        easiest way to exercise your rights is by contacting us.
                ...
                <div></div>
                <div>
                    <p style={stylingObject.heading_1}>TABLE OF CONTENTS</p>
                </div>
                <div></div>
                ...
                <div>
                    ...
                    <div>
                        <p>
                            If you use the Services to apply for a job with us,
                            we will collect information that you provide in
                            pre-qualification questionnaires that you submit
                            through our websites, and information included in
                            other materials that you submit as part of your
                            application, including as may be included on your
                            resume and application form. This information may
                            include your personal and contact details and
                ...
                <div>
                    ...
                    <div>
                        <p>
                            ...
                            information if you choose to provide us with access
                            or permission:
                        </p>
                    </div>
                    <div>
                        <ul>
                            <li>
                                <p>
                                    <i>Push Notifications</i>. We may request to
                                    send you push notifications regarding your
                                    account or certain features of the
                                    application(s). If you wish to opt out from
                ...
                <div>
                    ...
                    <div>
                        <ul>
                            <li>
                                <p>
                                    <i>Log and Usage Data.</i> Log and usage
                                    ...
                                    data/time stamps associated with your usage,
                            ...
                            <li>
                                <p>
                                    <i>Device Data.</i> We collect device data
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    request feedback and to contact you about
                            ...
                            <li>
                                <p>
                                    ...
                                    information, see "
                                    <a
                                        href='https://www.cydoc.ai/privacypolicy#privacyrights'
                                        target='_blank'
                                        rel='noreferrer noopener'
                                    >
                    ...
                    <div>
                        <ul>
                            ...
                            <li>
                                <p>
                                    <strong>
                                        To evaluate or participate in an actual
                                        or potential merger, divestiture,
                                        restructuring, reorganization,
                                        dissolution, or other sale or transfer
                                        of some or all of our assets, including
                ...
                <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    with you within our Services, and view your
                                    profile.
                                </p>
                            </li>
                        </ul>
                    ...
                    <div>
                        <p>
                            ...
                            <br />
                            <br />
                            When we have an ongoing legitimate business need to
                ...
                <div>
                    <p>
                        <i>
                            <strong>In Short:</strong> You may review, change,
                        ...
                        <a
                            href='https://www.cydoc.ai/privacypolicy#contact'
                            target='_blank'
                            rel='noreferrer noopener'
                        >
                ...
                <div>
                    <p style={stylingObject.heading_2}>
                        ...
                        may contact our Data Protection Officer (DPO), Rachel
                        Draelos, MD, PhD, by email at 
                        <a
                            href='mailto:%20admin@cydoc.ai'
                            target='_blank'
                            rel='noreferrer noopener'
                ...
                <div>
                    <p style={stylingObject.heading_2}>
                        ...
                        <a
                            href='https://www.cydoc.ai/www.cydoc.ai'
                            target='_blank'
                            rel='noreferrer noopener'
                        >
                             www.cydoc.ai
