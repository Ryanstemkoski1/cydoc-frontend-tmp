export const PART_OF_SPEECH_CORRECTION_MAP: Map<string, string> = new Map([
    ...
    [' 2 times ', ' twice '],
    [' 2 time ', ' twice '],
    [' 1 full brothers ', ' one full brother '],
    [' 1 half brothers ', ' one half brother '],
    [' 1 paternal half brothers ', ' one paternal half brother '],
    [' 1 maternal half brothers ', ' one maternal half brother '],
    [' 1 full sisters ', ' one full sister '],
    [' 1 half sisters ', ' one half sister '],
    [' 1 paternal half sisters ', ' one paternal half sister '],
    [' 1 maternal half sisters ', ' one maternal half sister '],
    [' he currently live ', ' he currently lives '],
    [' she currently live ', ' she currently lives '],
    [' he currently engage in ', ' he currently engages in '],
    [' she currently engage in ', ' she currently engages in '],
