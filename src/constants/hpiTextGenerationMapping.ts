export const PART_OF_SPEECH_CORRECTION_MAP: Map<string, string> = new Map([
    ...
    [' thoughts racing through your head keeping you awake ', ' racing thoughts '],
    [' during the day talking more or talking really fast ', ' hyperverbal speech '],
    [' more risk-taking behavior like driving fast ', ' increased risk-taking '],
