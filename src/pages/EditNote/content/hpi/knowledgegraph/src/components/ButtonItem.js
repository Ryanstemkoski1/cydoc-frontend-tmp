...
class ButtonItem extends React.Component {
    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            diseaseArray: this.context['positivecategories'].includes(
                this.props.name
            )
                ? diseaseButtons
                : [],
    ...
    handleClick() {
        if (!this.context['positivecategories'].includes(this.props.name)) {
            ...
            this.context['positivecategories'].splice(
                this.context['positivecategories'].indexOf(this.props.name),
                1
            );
        }
    }
    ...
    render() {
        return (
            <div>
                ...
                <div className='diseases-array'>{this.state.diseaseArray}</div>
            </div>
        );
    }
}
