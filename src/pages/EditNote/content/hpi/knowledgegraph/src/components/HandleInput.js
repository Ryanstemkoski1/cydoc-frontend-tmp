...
class HandleInput extends React.Component {
    ...
    constructor(props, context) {
        ...
        answers =
            this.props.type === 'LIST-TEXT'
                ? values['response'][this.props.inputID]
                : values['response'];
        this.state = {
    ...
    handleInputChange = (event) => {
        ...
        if (this.props.type === 'LIST-TEXT')
            values['nodes'][this.props.node]['response'][this.props.inputID] =
                event.target.value;
    ...
    render() {
        let type = this.context['hpi']['nodes'][this.props.node][
            'responseType'
        ];
        if (type === 'SHORT-TEXT') {
            return (
