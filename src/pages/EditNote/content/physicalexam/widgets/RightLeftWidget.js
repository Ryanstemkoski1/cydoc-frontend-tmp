...
export default class RightLeftWidget extends Component {
    ...
    constructor(props, context) {
        ...
        this.state = {
            pe_types:
                this.props.type === 'Pulses'
                    ? [
                          ['brachial', 'radial', 'ulnar', 'dorsalis pedis'],
                          ['right', 'left'],
                          [
                              '0 absent',
                              '1+ weak',
    ...
    onButtonClick(event, data) {
        ...
        values.widgets[this.props.type][data.pe_index][data.index] =
            data.condition;
    ...
    addPulse(pe_index) {
        ...
        for (let index = 0; index < pe_types.length; index++) {
            pe_map.push(
                <div
                    style={{
                        marginTop: 10,
