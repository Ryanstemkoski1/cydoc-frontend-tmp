...
export default class FamilyHistoryDropdown extends Component {
    ...
    constructor(props, context) {
        ...
        let value =
            values[this.props.index]['Family Member'][this.props.family_index];
        this.state = {
    ...
    handleCauseOfDeathToggle(event, data) {
        ...
        values[index]['Cause of Death'][family_index] =
            data.title === 'Yes' ? true : false;
        values[index]['Living'][family_index] =
            data.title === 'Yes' ? false : '';
        this.context.onContextChange('Family History', values);
    }
    ...
    render() {
        ...
        const cause_of_death = this.context['Family History'][index][
            'Cause of Death'
        ][family_index];
