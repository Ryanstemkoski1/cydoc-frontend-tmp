...
import { Form, Grid, Button, Header, Divider } from 'semantic-ui-react';
...
export default class FamilyHistoryBlock extends Component {
    ...
    handlePlusClick() {
        ...
        let members = values[this.props.index]['Family Member'];
    ...
    render() {
        ...
        if (this.context['Family History'][index]['Family Member']) {
            range = this.context['Family History'][index]['Family Member']
                .length;
        }
        ...
        let noActive = this.context['Family History'][condition.props.index][
            'No'
        ];
        if (isPreview) {
            handleToggle = () => {};
            ...
            <Grid.Row>
                <Form className='family-hx-note-item'>
                    ...
                    <div className='condition-info'>
                        {this.context['Family History'][condition.props.index][
                            'Yes'
                        ] ? (
                            <>
                                {dropdown_list}
