...
const initialQuestions: InitialQuestionsState = {
    ...
    nodes: {
        ...
        '7': {
            uid: '7',
            text: 'If you’d like to discuss an additional condition or symptom not listed above, please search for it here:',
            responseType: ResponseTypes.SEARCH,
            category: '',
            doctorView: '',
        },
        '8': {
        ...
        '10': {
            uid: '10',
            text: 'If you could not find your condition or symptom, please describe it here in a few words:',
            responseType: ResponseTypes.LONG_TEXT,
            category: '',
            doctorView: '',
        },
    },
