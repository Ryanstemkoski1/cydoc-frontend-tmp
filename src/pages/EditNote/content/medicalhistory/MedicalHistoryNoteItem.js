...
export default class MedicalHistoryNoteItem extends Component {
    render = () => {
        const { yesActive, condition, onConditionToggleButtonClick, onResolvedToggleButtonClick, noActive, onset, onChange, comments, currentYear, isResolved, endYear} = this.props;
            ...
            <Form className="family-hx-note-item">
                ...
                {yesActive &&
                    ...
                    { onset !== "" && (onset < 1900 || onset > currentYear)  && (
                        <p className='year-validation-mobile-error'>Please enter a valid year after 1900</p>
                    )}
                    <span class="field">
                    ...
                    { isResolved == 'Yes' && 
                        <>
                            ...
                            rows={1}
                            />
                            {endYear !== "" && (endYear < 1900 || endYear > currentYear || endYear < onset)  && (
                                <p className='year-validation-mobile-error'>Please enter a valid year after 1900 and the onset</p>
                            )}
                        </>
                    }
