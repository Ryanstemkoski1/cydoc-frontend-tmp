              ...
              <MedicalHistoryNoteItem
                ...
                condition={
                  <ConditionInput
                    ...
                    addSeenCondition={this.addSeenCondition}
                    condition={
                      this.context['Medical History'][condition]['Condition']
                    }
                  />
                }
              ...
              <MedicalHistoryNoteRow
                ...
                condition={
                  <ConditionInput
                    ...
                    addSeenCondition={this.addSeenCondition}
                    condition={
                      this.context['Medical History'][condition_index][
                        'Condition'
                      ]
                    }
                  />
                ...
                onset={
                  this.context['Medical History'][condition_index]['Onset']
                }
                comments={
                  this.context['Medical History'][condition_index]['Comments']
                }
                onChange={this.handleChange}
                onToggleButtonClick={this.handleToggleButtonClick}
                yesActive={
                  this.context['Medical History'][condition_index]['Yes']
                }
                noActive={
                  this.context['Medical History'][condition_index]['No']
                }
              />
            );
          }
