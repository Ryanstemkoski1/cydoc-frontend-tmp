            ...
            <div>
                ...
                <Segment>
                    ...
                    <MedicalHistoryNote
                        ...
                        medicalHistory={this.context['Medical History']}
                    />
                    <h4> Surgical History </h4>
                    <SurgicalHistoryNote
                        isRich={this.state.rich}
                        surgicalHistory={this.context['Surgical History']}
                    />
                    <h4> Medications </h4>
                    <MedicationsNote
                        isRich={this.state.rich}
                    ...
                    <AllergiesNote
                        isRich={this.state.rich}
                        allergies={this.context['Allergies']}
                    />
                    <h4> Social History </h4>
                    <SocialHistoryNote
                        socialHistory={this.context['Social History']}
                    />
                    <h4> Family History </h4>
                    <FamilyHistoryNote
                        familyHistory={this.context['Family History']}
                    />
                    <h3> Review of Systems </h3>
                    <ReviewOfSystemsNote
                        reviewOfSystems={this.context['Review of Systems']}
                    />
                    <h3> Physical Exam </h3>
                    <PhysicalExamNote
                        isRich={this.state.rich}
                        physicalExam={this.context['Physical Exam']}
                    />
                    <h3> Plan </h3>
