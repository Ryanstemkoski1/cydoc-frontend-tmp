...
class GenerateNote extends React.Component {
    ...
    medicalHistory() {
        ...
        const conditions = [];
        for (let condition in medicalHistory) {
                    ...
                    <Table.Body>
                        {Object.keys(conditions).map((key, index) => (
                            <Table.Row key={index}>
                                ...
                                <Table.Cell>
                                    {conditions[key].Onset
                                        ? conditions[key].Onset
                                        : null}
                                </Table.Cell>
                                <Table.Cell>
                                    {conditions[key].Comments
                                        ? conditions[key].Comments
                                        : null}
                                </Table.Cell>
                            </Table.Row>
                        ...
                        {Object.keys(surgicalHistory).map((key) =>
                            surgicalHistory[key].Procedure !== '' ? (
                                <Table.Row>
                                    ...
                                    <Table.Cell>
                                        {surgicalHistory[key].Date
                                            ? surgicalHistory[key].Date
                                            : null}
                                    </Table.Cell>
                                    <Table.Cell>
                                        {surgicalHistory[key].Comments
                                            ? surgicalHistory[key].Comments
                                            : null}
                                    </Table.Cell>
                                </Table.Row>
                        ...
                        {Object.keys(medications).map((key) =>
                            medications[key]['Drug Name'] ? (
                                <Table.Row>
                                    ...
                                    {medications[key]['Start Date'] ? (
                                        <Table.Cell>
                                            {medications[key]['Start Date']}
                                        </Table.Cell>
                                    ) : null}
                                    {medications[key]['Schedule'] ? (
                                        <Table.Cell>
                                            {medications[key]['Schedule']}
                                        </Table.Cell>
                                    ) : null}
                                    {medications[key]['Dose'] ? (
                                        <Table.Cell>
                                            {medications[key]['Dose']}
                                        </Table.Cell>
                                    ) : null}
                                    {medications[key]['Reason for Taking'] ? (
                                        <Table.Cell>
                                            {
                                                medications[key][
                                                    'Reason for Taking'
                                    ...
                                    {medications[key]['Side Effects'] ? (
                                        <Table.Cell>
                                            {medications[key]['Side Effects']}
                                        </Table.Cell>
                                    ) : null}
                                    {medications[key]['Comments'] ? (
                                        <Table.Cell>
                                            {medications[key]['Comments']}
                                        </Table.Cell>
                                    ) : null}
                    ...
                    medications[key]['Drug Name'] ? (
                        <div>
                            ...
                            <ul>
                                ...
                                {medications[key]['Schedule'] ? (
                                    <li key={key}>
                                        Schedule: {medications[key]['Schedule']}
                                    </li>
                                ) : null}
                                {medications[key]['Dose'] ? (
                                    <li key={key}>
                                ...
                                {medications[key]['Side Effects'].length > 0 ? (
                                    <li key={key}>
                                        Side Effects:{' '}
                                        {medications[key]['Side Effects'].join(
                                            ', '
                                        )}
                                    </li>
                                ) : null}
                                {medications[key]['Comments'] ? (
                                    <li key={key}>
                                        Comments: {medications[key]['Comments']}
                                    </li>
                                ) : null}
                            </ul>
                        </div>
    ...
    alcoholProductsUsed(socialHistory) {
        ...
        Object.keys(alcohol).map((key) => {
            const product = `${alcohol[key]['Drink Type']} (${
                ...
                parseInt(alcohol[key]['# Per Week']) !== 1 ? 's' : ''
            } per week)`;
        ...
        return (
            <div>
                <div>
                    ...
                    <ul>
                        ...
                        {socialHistory.Tobacco['In the Past'] === true ? (
                            <li>Used to use tobacco but does not anymore</li>
                        ) : null}
                        {socialHistory.Tobacco['Quit Year'] ? (
                            <li>
                                Quit Year: {socialHistory.Tobacco['Quit Year']}
                            </li>
                        ) : null}
                        ...
                        {socialHistory.Tobacco['Products Used'] ? (
                            <li>
                                Products used:{' '}
                                {socialHistory.Tobacco['Products Used'].join(
                                    ', '
                                )}
                            </li>
                        ) : null}
                        ...
                        {socialHistory.Tobacco['Yes'] === true ||
                        socialHistory.Tobacco['In the Past'] === true ? (
                            <li>{this.triedToQuit(socialHistory.Tobacco)}</li>
                        ) : null}
                ...
                <div>
                    ...
                    <ul>
                        ...
                        {socialHistory.Alcohol['In the Past'] === true ? (
                            <li>Used to use alcohol but does not anymore</li>
                        ) : null}
                        {socialHistory.Alcohol['Quit Year'] ? (
                            <li>
                                Quit Year: {socialHistory.Alcohol['Quit Year']}
                            </li>
                        ) : null}
                        {socialHistory.Alcohol['Never Used'] === true ? (
                            <li>Never used</li>
                        ) : null}
                        {socialHistory.Alcohol['fields'][0]['Drink Type'] !==
                        '' ? (
                            <li>
                                Products used:{' '}
                        ...
                        {socialHistory.Alcohol['Yes'] === true ||
                        socialHistory.Alcohol['In the Past'] === true ? (
                            <li>{this.triedToQuit(socialHistory.Alcohol)}</li>
                        ) : null}
                ...
                <div>
                    ...
                    <ul>
                        {socialHistory['Recreational Drugs']['Yes'] === true ? (
                            <li>Currently uses substances</li>
                        ) : null}
                        {socialHistory['Recreational Drugs']['In the Past'] ===
                        true ? (
                            <li>Used to use substances but does not anymore</li>
                        ) : null}
                        {socialHistory['Recreational Drugs']['Quit Year'] ? (
                            <li>
                                Quit Year:{' '}
                                {
                ...
                <div>
                    {' '}
                    <b>Employment: </b> {socialHistory.Employment}{' '}
                </div>
                <div>
                    {' '}
                    <b>Diet: </b> {socialHistory.Diet}{' '}
                </div>
                <div>
                    {' '}
                    <b> Exercise: </b> {socialHistory.Exercise}{' '}
                </div>
            </div>
        );
    }
    ...
    familyHistory() {
        ...
        let components = [];
        for (let condition in familyHistory) {
            let familyMembers = [];
            if (familyHistory[condition].Yes === true) {
                if (familyHistory[condition]['Family Member']) {
                    for (let member in familyHistory[condition][
                        'Family Member'
                    ]) {
                        if (
                            familyHistory[condition]['Cause of Death'][member]
                        ) {
                            familyMembers.push(
                                `${familyHistory[condition]['Family Member'][member]} (cause of death)`
                            );
                        } else {
                            familyMembers.push(
                                familyHistory[condition]['Family Member'][
                                    member
                                ]
                            );
                        }
    ...
    physicalExam() {
        ...
        for (let key in physical) {
            ...
            if (key === 'Vitals') {
                if (
                    physical[key]['Systolic Blood Pressure'] !== 0 ||
                    physical[key]['Diastolic Blood Pressure'] !== 0
                ) {
                    vitals.push(
                        physical[key]['Systolic Blood Pressure'] +
                            '/' +
                            physical[key]['Diastolic Blood Pressure'] +
                            ' mmHg'
                    );
                }
                for (let vital in physical[key]) {
                    if (
                        vital !== 'Systolic Blood Pressure' &&
                        vital !== 'Diastolic Blood Pressure' &&
                        physical[key][vital] !== 0
                    ) {
                        vitals.push(
                            vital +
                                ': ' +
                ...
                for (let widget in physicalWidgets) {
                    if (widget === 'Pulses') {
                        for (let pulse in physicalWidgets[widget]) {
                            let abnormalPulse = physicalWidgets[widget][pulse];
                            widgets['Pulses'].push(
                                abnormalPulse[2] +
                                    ' ' +
                                    abnormalPulse[1] +
                        ...
                        let findings = {};
                        for (let quadrant in physicalWidgets[widget]) {
                            let quadrantInfo =
                                physicalWidgets[widget][quadrant];
                            for (let info in quadrantInfo) {
                        ...
                        let findings = {};
                        for (let lobe in physicalWidgets[widget]) {
                            let lobeInfo = physicalWidgets[widget][lobe];
                            for (let finding in lobeInfo) {
                                if (lobeInfo[finding]) {
                        ...
                        for (let reflex in physicalWidgets[widget]) {
                            let reflexInfo = physicalWidgets[widget][reflex];
                            widgets['Tendon Reflexes'].push(
                                reflexInfo[2] +
                                    ' ' +
                                    reflexInfo[1] +
                                    ' ' +
                        ...
                        for (let murmur in physicalWidgets[widget]) {
                            let murmurInfo = physicalWidgets[widget][murmur];
                            let crescDecres =
                                murmurInfo['cresdecres'] === 'cresc-decresc'
                                    ? 'crescendo-decrescendo'
                                    : murmurInfo['cresdecres'];
                            let quality =
                                murmurInfo['quality'] !== ''
                                    ? ' with a ' +
                                      murmurInfo['quality'].join(', ') +
                                      ' quality'
                                    : null;
                            let heardBest =
                                murmurInfo['heardbest'] !== ''
                                    ? ' heard best at ' +
                                      murmurInfo['heardbest']
                                    : null;
                            let finding =
                                murmurInfo['systdiast']
                                    .substring(0, 1)
                                    .toUpperCase() +
                                murmurInfo['systdiast'].substring(1) +
                                ' ' +
                                crescDecres +
                                ' murmur' +
                                quality +
                        ...
                        // for (let expand in physicalWidgets[widget]) {
                        //     let findings = [];
                        //     let expandInfo = physicalWidgets[widget][expand];
                        // }
                    }
                }
                // everything else in physical exam
            } else {
                for (let question in physical[key]) {
                    // deals with findings that have a left or right option
                    if (
                        typeof physical[key][question] === 'object' &&
                        keyObject
                    ) {
                        let isNormal = true;
                        for (let i = 0; i < keyObject.rows.length; i++) {
                            if (keyObject.rows[i].findings.includes(question)) {
                                keyObject.rows[i].normalOrAbnormal === 'normal'
                                    ? (isNormal = true)
                                    : (isNormal = false);
                            }
                        }
                    ...
                    // gets comments section of physical exam
                        ...
                        typeof physical[key][question] === 'string' &&
                        physical[key] !== 'Vitals'
                    ) {
    ...
    plan() {
        ...
        return Object.keys(conditions).map((key, index) => (
            <div key={index}>
                ...
                <ol>
                    {Object.keys(conditions[key].differential_diagnosis).map(
                        (condition) => (
                            <li key={key}>
                                <b>
                                    {
                                        conditions[key].differential_diagnosis[
                                            condition
                                        ].diagnosis
                                    }
                                    :{' '}
                ...
                <b>Prescriptions</b>
                <ul>
                    {Object.keys(conditions[key].prescriptions).map(
                        (prescription) => (
                            <li key={key}>
                                <b>
                                    {
                                        conditions[key].prescriptions[
                                            prescription
                                        ].recipe_type
                                    }{' '}
                                </b>
                                ...
                                {
                                    conditions[key].prescriptions[prescription]
                                        .comment
                                }
                            </li>
                        )
                ...
                <ul>
                    {Object.keys(conditions[key].procedures_and_services).map(
                        (procedure) => (
                            <li key={key}>
