...
class PhysicalExamNote extends React.Component {
    ...
    render() {
            ...
            if (key === 'Vitals') {
                if (
                    (physical[key]['Systolic Blood Pressure'] !== 0 &&
                        physical[key]['Systolic Blood Pressure'] !== null) ||
                    (physical[key]['Diastolic Blood Pressure'] !== 0 &&
                        physical[key]['Diastolic Blood Pressure'] !== null)
                ) {
                    vitals.push(
        ...
        for (const component in components) {
            if (
                !(
                    components[component].active.length === 0 &&
            ...
            <ul>
                ...
                {Object.keys(components).map((key) =>
                    ...
                    widgets[key].length > 0 ? (
                        <li>
                            <b>{key}: </b>
                            {this.displayComments(components[key].comments) +
                                components[key].active.join(', ') +
                                '. ' +
                                widgets[key].join(', ') +
                                '.'}
