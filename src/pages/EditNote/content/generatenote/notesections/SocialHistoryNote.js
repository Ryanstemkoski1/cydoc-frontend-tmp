...
class SocialHistoryNote extends React.Component {
    ...
    alcoholProductsUsed(socialHistory) {
        ...
        Object.keys(alcohol).map(key => {
            const product = `${alcohol[key]['Drink Type']} (${alcohol[key]['# Per Week']} ${alcohol[key]['Drink Size']}${parseInt(alcohol[key]['# Per Week']) !== 1 ? alcohol[key]['Drink Size'].endsWith('s') ? 'es' : 's' : ''} per week)`;
    ...
    checkEmptyAnswers(socialHistorySection) {
        if (socialHistorySection['TriedToQuit']['Yes'] === false && socialHistorySection['TriedToQuit']['No'] === false) {
            return true;
        }
        if (socialHistorySection['InterestedInQuitting']['Yes'] === false && socialHistorySection['InterestedInQuitting']['Maybe'] && socialHistorySection['InterestedInQuitting']['No'] === false) {
            return true;
        }
        return false;
    }
            ...
            <div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        {(socialHistory.Tobacco['Yes'] === true || socialHistory.Tobacco['In the Past'] === true) && !this.checkEmptyAnswers(socialHistory.Tobacco) ? <li>{this.interestedInQuitting(socialHistory.Tobacco)}</li> : null}
                ...
                <div>
                    ...
                    <ul>
                        ...
                        {(socialHistory.Alcohol['Yes'] === true || socialHistory.Alcohol['In the Past'] === true) && !this.checkEmptyAnswers(socialHistory.Alcohol) ? <li>{this.interestedInQuitting(socialHistory.Alcohol)}</li> : null}
                ...
                <div>
                    ...
                    <ul>
                        ...
                        {(socialHistory['Recreational Drugs']['Yes'] === true || socialHistory['Recreational Drugs']['In the Past'] === true) && !this.checkEmptyAnswers(socialHistory['Recreational Drugs']) ? <li>{this.interestedInQuitting(socialHistory['Recreational Drugs'])}</li> : null}
