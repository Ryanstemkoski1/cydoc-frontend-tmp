    ...
    render() {
        return (
            <Segment className='landing-page-columns'>
                ...
                <Modal trigger={<Button className='right-bottom-button'>New Template Group...</Button>}>
    ...
    render() {
        ...
        return (
            <Segment className='my-notes-modal'>
                ...
                <Input as={'h2'} size='massive' transparent placeholder='Untitled Template Group'></Input>

                <Divider />

                <Header as={'h3'}>Each section of this group will have the following template:</Header>
                            ...
                            <Menu as={Form} secondary vertical style={{width: '100%'}}>
                                ...
                                <Form.Group>
                                    <Radio
                                        ...
                                        name='Show All'
                                        value='Show All'
                                        checked={this.state.activeHPITemplate === 'Show All'}
                                    ...
                                    return (
                                        <Form.Group>
                                            <Radio
                                                ...
                                                name={template}
                                                value={template}
                                                checked={this.state.activeHPITemplate === template}
                                                onChange={this.handleHPIChange}
                                            ></Radio>
                                        </Form.Group>
                                    )
                            ...
                            <Menu as={Form} secondary vertical style={{width: '100%'}}>
                                ...
                                <Form.Group>
                                    <Radio
                                        ...
                                        name='Show All'
                                        value='Show All'
                                        checked={this.state.activePETemplate === 'Show All'}
                                    ...
                                    return (
                                        <Form.Group>
                                            <Radio
                                                ...
                                                name={template}
                                                value={template}
                                                checked={this.state.activePETemplate === template}
                                                onChange={this.handlePEChange}
                                            ></Radio>
                                        </Form.Group>
                                    )
                            ...
                            <Menu as={Form} secondary vertical style={{width: '100%'}}>
                                ...
                                <Form.Group>
                                    <Radio
                                        ...
                                        name='Show All'
                                        value='Show All'
                                        checked={this.state.activeRoSTemplate === 'Show All'}
                                    ...
                                    return (
                                        <Form.Group>
                                            <Radio
                                                ...
                                                name={template}
                                                value={template}
                                                checked={this.state.activeRoSTemplate === template}
                                                onChange={this.handleRoSChange}
                                            ></Radio>
                                        </Form.Group>
                                    )
