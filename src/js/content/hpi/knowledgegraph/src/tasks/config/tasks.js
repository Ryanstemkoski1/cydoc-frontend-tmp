...
module.exports = {
  ...
  filenames: {
    concatenatedCSS            : 'src.css',
    concatenatedJS             : 'src.js',
    concatenatedMinifiedCSS    : 'src.min.css',
    concatenatedMinifiedJS     : 'src.min.js',
    concatenatedRTLCSS         : 'src.rtl.css',
    concatenatedMinifiedRTLCSS : 'src.rtl.min.css'
  },
