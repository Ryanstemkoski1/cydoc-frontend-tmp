...
const PatientQRCodePage = React.forwardRef<HTMLDivElement, Props>(
    (props, ref) => {
        ...
        return (
            ...
            >
                <div
                    ref={ref}
                    className={`${style.patientQR} ${style.isAlterNative}`}
                >
...
PatientQRCodePage.displayName = 'PatientQRCodePage';
